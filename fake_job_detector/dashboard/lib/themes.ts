export const themes = {
  ...
  matrix: {
    ...
    light: {
      ...
      "glow-color": "oklch(0.72 0.15 145 / 0.15)",
      "glow-color-strong": "oklch(0.72 0.15 145 / 0.25)",
    },
    dark: {
      background: "oklch(0.06 0.015 260)",
      foreground: "oklch(0.96 0 0)",
      ...
      "glow-color": "oklch(0.75 0.14 150 / 0.12)",
      "glow-color-strong": "oklch(0.75 0.14 150 / 0.22)",
    },
  },
  purple: {
    name: "Purple",
